...
public interface SeriesService {
    ...
    @GET("/v1/public/series")
    public DataWrapper<Series> listSerie(@QueryMap Map<ListSerieParamName, String> options) throws AuthorizationException, QueryException;
    ...
    @GET("/v1/public/series/{seriesId}/characters")
    public DataWrapper<Character> getSerieCharacters(@Path("seriesId") int seriesId, @QueryMap Map<GetSerieCharactersParamName, String> options) throws AuthorizationException, QueryException;
    ...
    @GET("/v1/public/series/{seriesId}/comics")
    public DataWrapper<Comic> getSerieComics(@Path("seriesId") int seriesId, @QueryMap Map<GetSerieComicsParamName, String> options) throws AuthorizationException, QueryException;
    ...
    @GET("/v1/public/series/{seriesId}/creators")
    public DataWrapper<Creator> getSerieCreators(@Path("seriesId") int seriesId, @QueryMap Map<GetSerieCreatorsParamName, String> options) throws AuthorizationException, QueryException;
    ...
    @GET("/v1/public/series/{seriesId}/events")
    public DataWrapper<Event> getSerieEvents(@Path("seriesId") int seriesId, @QueryMap Map<GetSerieEventsParamName, String> options) throws AuthorizationException, QueryException;
    ...
    @GET("/v1/public/series/{seriesId}/stories")
    public DataWrapper<Story> getSerieStories(@Path("seriesId") int seriesId, @QueryMap Map<GetSerieStoriesParamName, String> options) throws AuthorizationException, QueryException;
}
